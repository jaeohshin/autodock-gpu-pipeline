...
python dlg_processor.py --all --processes 20

Or specify kinase 
python dlg_processor.py --test-kinase src --processes 20
sbatch -N 1 -c 20 --mem=32G --time=4:00:00 --wrap="python ada_full_processor.py --all --processes 20"
"""
